...
RenderSystem::RenderSystem()
{
	...
	if (FAILED(res))
		throw std::exception("Failed to create {RenderSystem}. Error in ctor.");
...
SwapChainPtr RenderSystem::createSwapChain(HWND hwnd, UINT width, UINT height)
{
	...
	{
		throw std::exception("Failed to create {SwapChainPtr}. Error in ctor {RenderSystem::createSwapChain(...)}.");
	}
	return sc;
}
...
VertexBufferPtr RenderSystem::createVertexBuffer(void* list_vertices, UINT size_vertex, UINT size_list, void* shader_byte_code, UINT size_byte_shader)
{
	...
	{
		throw std::exception("Failed to create {VertexBufferPtr}. Error in {RenderSystem::createVertexBuffer(...)}.");
	}
	return vb;
}
...
IndexBufferPtr RenderSystem::createIndexBuffer(void* list_indices, UINT size_list)
{
	...
	{
		throw std::exception("Failed to create {IndexBufferPtr}. Error in {RenderSystem::createIndexBuffer(...)}.");
	}
	return ib;
}
...
ConstantBufferPtr RenderSystem::createConstantBuffer(void* buffer, UINT size_buffer)
{
	...
	{
		throw std::exception("Failed to create {ConstantBufferPtr}. Error in {RenderSystem::createConstantBuffer(...)}.");
	}
	return cb;
}
...
VertexShaderPtr RenderSystem::createVertexShader(const void* shader_byte_code, size_t byte_code_size)
{
	...
	{
		throw std::exception("Failed to create {VertexShaderPtr}. Error in {RenderSystem::createVertexShader(...)}.");
	}
	return vs;
}
...
PixelShaderPtr RenderSystem::createPixelShader(const void* shader_byte_code, size_t byte_code_size)
{
	...
	{
		throw std::exception("Failed to create {PixelShaderPtr}. Error in {RenderSystem::createPixelShader(...)}.");
	}
	return ps;
}
