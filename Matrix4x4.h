...
public:
	...
	{
		m_mat[1][1] = cos(rotation.m_x);
		m_mat[1][2] = sin(rotation.m_x);
		m_mat[2][1] = -sin(rotation.m_x);
		m_mat[2][2] = cos(rotation.m_x);

		m_mat[0][0] = cos(rotation.m_y);
		m_mat[0][2] = -sin(rotation.m_y);
		m_mat[2][0] = sin(rotation.m_y);
		m_mat[2][2] = cos(rotation.m_y);

		m_mat[0][0] = cos(rotation.m_z);
